...
Este projeto representa o trabalho final do **IBM Data Analyst**, demonstrando competências avançadas na área. A plataforma desenvolvida oferece uma solução completa e funcional.

**Desenvolvido por:** Gabriel Demetrios Lafis  
**Certificação:** IBM Data Analyst  
...
This project represents the capstone work for the **IBM Data Analyst**, demonstrating advanced competencies in the field. The developed platform offers a complete and functional solution.
